...
<ul id="nav">
    <li>
        <a href="index.php" onmouseover="document.homeButton.src='img/template/nav/homeGlow.png'" onmouseout="document.homeButton.src='img/template/nav/home.png'">
            <img src="img/template/nav/home.png" name="homeButton">
        </a>
    </li>
    ...
    <li>
        ...
        <ul>
            <li><a href="http://azulox.zenfolio.com/joust2011" target="_blank">Photos</a></li>
            <li><a href="http://www.youtube.com/aplaisanceltd" target="_blank">Videos</a></li>
        </ul>
    </li>
    <li>
    ...
    <li>
        ...
        <ul>
            <li><a href="http://eafk.org" target="_blank">Early Act First Knight</a></li>
            <li><a href="http://www.azulox.com" target="_blank">AzulOx Photography</a></li>
